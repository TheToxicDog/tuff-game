...
const N: NodeDef[] = [
  ...
  },
  {
    ...
    drops: [
      ...
      { item: 'assembler_blueprint', rate: 1, chance: 0.003 },
    ],
    amount: 16,
    regrow: 900,
    solid: true,
  ...
  },
  {
    ...
    drops: [
      { item: 'hardwood', rate: 0.5 },
      { item: 'rope', rate: 0.3, chance: 0.5 },
      { item: 'scrap_metal', rate: 0.4 },
      { item: 'gold_ingot', rate: 1, chance: 0.01 },
      { item: 'rough_gem', rate: 1, chance: 0.005 },
      { item: 'steam_blueprint', rate: 1, chance: 0.003 },
    ],
    amount: 30,
    regrow: 1800,
    solid: true,
