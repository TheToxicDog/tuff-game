...
export const RESEARCH: readonly ResearchNode[] = [
  ...
  },
  {
    ...
    name: 'Deep Mining',
    cost: 90,
    requires: ['ore_processing'],
    desc: 'Mechanical drills that mine a vein, seam or rock without end.',
    col: 3,
    row: 2,
  },
  {
    ...
    cost: 120,
    requires: ['steel'],
    desc: 'Monuments: obelisk, fountain, statue and beacon. Prestige, at a price.',
    col: 4,
    row: 0,
  },
  {
